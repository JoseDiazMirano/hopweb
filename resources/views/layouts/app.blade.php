...
<head>
    ...
    <title>Higienika Oficce|Panel administrativo</title>
    <!-- Scripts -->
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('img/favicon_higienika_office_peru.png')}}" alt="Higinika oficce logo" class="brand-image img-circle"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">Higienika Oficce</span>
                </a>
