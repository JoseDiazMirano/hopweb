...
<body> 
    ...
    <script>
        ...
        strings: ['<span><i class="fas fa-paint-brush"></i></span> LIMPIEZA', 
                    '<span><i class="fas fa-building"></i></span> ÚTILES DE OFICINA'
                    ,'<span><i class="fas fa-coffee"></i></span> INSUMOS PARA CAFETERÍA'],
