...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Higienika Oficce|Productos</title>
    ...
    strings: ['<span><i class="fas fa-check"></i></span> LMPIEZA', 
                '<span><i class="fas fa-check"></i></span> SEGURIDAD',
                '<span><i class="fas fa-check"></i></span> UTILES ESCOLARES'],
