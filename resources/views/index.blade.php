...
<div class="red">
    <div id="facebook">
        <a href="https://www.facebook.com/Higienika-Office-105736217852828" target="none" class="fab fa-facebook-f "></a>
    </div>
    <div id="instagram">
        <a href="https://www.instagram.com/higienikaofficepe/" target="none" class="fab fa-instagram"></a>
    </div>
    <div id="twiter">
        <a href="" target="none" class="fab fa-twitter-square"></a>
    </div>
    <div id="whatsaap">
        <a href="https://api.whatsapp.com/send?phone=51936201274&text=" target="none" class="fab fa-whatsapp"></a>
    </div>
    <div id="linkeding">
        <a href="https://www.linkedin.com/in/higienikaperu/" target="none" class="fab fa-linkedin"></a>
    </div>
</div>
@endsection
@section('navbar_top')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-text">
						...
						<br>
						<br>
                        <h1 class="tipeo1">LÍDER EN PRODUCTOS DE</h1>
    ...
    <div class="row_cards">
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="single-content">
                <img src="{{ asset('img/categoria/categoria_productos_cafeteria_higienika_office_peru_1.jpg')}}" alt="Categorias Higienika Oficce Perú">
                <div class="text-content">
                    <h3>Productos de Limpieza</h3>
                    <hr class="style2">
                    <h5>productos de limpieza para el hogar y oficina</h5>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="single-content">
                <img src="{{ asset('img/categoria/categoria_productos_de_oficina_higienika_office_peru.jpg')}}" alt="Categorias Higienika Oficce Perú">
                <div class="text-content">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="single-content">
                <img src="{{ asset('img/categoria/categoria_productos_limpieza_higienika_office_peru.jpg')}}" alt="Categorias Higienika Oficce Perú">
                <div class="text-content">
                    <h3>Insumos Para Cafetería</h3>
                    <hr class="style2">
                    <h5>Distribuimos insumos para Cafetería</h5>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="single-content">
                <img src="{{ asset('img/categoria/categoria_productos_seguridad_higienika_office_peru.jpg')}}" alt="Categorias Higienika Oficce Perú">
                <div class="text-content">
                    <h3>Artículos de seguridad</h3>
                    <hr class="style2">
                    <h5>Artículos Para la seguridad en ambientes de trabajo</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="carousel_prove">
        ...
        <div class="item">
            <div class="content">
                ...
                <hr class="">
                <h5 style="color: white">En Higienika office Perú nos preocupamos por la satisfacción del cliente y su bienestar es por eso que contamos con nuestros proveedores que son líderes en su rubro y es por eso que sus productos son recomendables.</h5>
            </div>
            <div class="img">
...
<footer class="footer">
    <div class="l-footer">
        <img  class="footer_img" src="{{asset('img/Logo-Higienika_office_peru_div.png')}}" alt="Logo Higienika Oficce Perú">
                      ...
                      <div class="plan-inner">
                        ...
                        <div class="entry-content">
                          <ul>
                            ...
                            <li>192-90686530-0-53</li>
                            <li>N° de cta. interbancaria</li>
                            <li>002-19219068653005334</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="plan basic">
                      <div class="plan-inner">
                        ...
                        <div class="entry-content">
                          <ul>
                            <li>Número de cuenta</li>
                            <li>001105210200202468</li>
                            <li>N° de cta. interbancaria</li>
                            <li>01152100020020246821</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                ...
                <div id="contenedor" class="row_p">
                    ...
                    <div id="verde" class="content_pagos"> 
                        ...
                        <button type="button" class="btnwssp btn btn-outline-success btn-lg">
                            <a target="none" href="https://wa.me/51936201274?text=Hola%2CHigienika+Oficce+Perú%3A%0D%0AEstoy+interesad%40+en+la+oferta%3A+{{$oferta->titulo}}">
                               Preguntar
                            </a>
                        </button> 
                    </div>
